...
public class ContactUniquenessException extends ContactException {
    public ContactUniquenessException(String message) {
        super(message);
    }

    public ContactUniquenessException(Throwable throwable) {
        super(throwable);
    }

    public ContactUniquenessException(String message, Throwable throwable) {
