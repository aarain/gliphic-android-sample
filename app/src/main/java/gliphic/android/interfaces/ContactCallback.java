...
/**
 * An interface allowing a Contact return value from a method which contains another interface.
 *
...
public interface ContactCallback extends BaseContactCallback {
    void onReturn(final Contact contact);
}
