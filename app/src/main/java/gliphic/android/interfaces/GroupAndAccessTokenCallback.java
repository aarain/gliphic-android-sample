...
/**
 * An interface allowing a group and an access token to be returned from a method which contains another interface.
 *
...
public interface GroupAndAccessTokenCallback extends BaseGroupCallback {
    void onReturn(final Group group, final String accessToken);
}
