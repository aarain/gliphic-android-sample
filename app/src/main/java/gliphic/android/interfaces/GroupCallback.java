...
/**
 * An interface allowing a group to be returned from a method which contains another interface.
 *
...
public interface GroupCallback extends BaseGroupCallback {
    void onReturn(final Group group);
}
